...
import com.cfx.usercenter.security.core.ProviderManager;
 ...
 * 认证实现是通过委托的设计模式去设计实现的，认证方案统一由{@link com.cfx.usercenter.security.core.AuthenticationProvider}
 * 来提供.
 * 基于安全考虑，设计之初采用了双重认证（多因子认证）方案，即再{@link com.cfx.usercenter.security.core.AuthenticationProvider#authenticate(Authentication)}
