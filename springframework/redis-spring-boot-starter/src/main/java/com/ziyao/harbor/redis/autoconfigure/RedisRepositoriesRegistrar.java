...
import com.ziyao.harbor.redis.autoconfigure.config.RedisRepositoryConfigurationExtension;
...
//        AnnotationMetadata metadata2 = AnnotationMetadata.introspect(getConfiguration());
        StandardAnnotationMetadata metadata2 = new StandardAnnotationMetadata(getConfiguration(), true);
