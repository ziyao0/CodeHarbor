package com.ziyao.harbor.oauth2.http;
...
//        setOutputStreaming(false);
    ...
    protected void prepareConnection(@NonNull HttpURLConnection connection, @NonNull String httpMethod) throws IOException {
        if (connection instanceof HttpsURLConnection) {
            ...
            TrustManager[] trustAllCerts = new TrustManager[]{new UncheckedX509TrustManager()};
     ...
     * 不检查证书
     */
    static class UncheckedX509TrustManager implements X509TrustManager {
