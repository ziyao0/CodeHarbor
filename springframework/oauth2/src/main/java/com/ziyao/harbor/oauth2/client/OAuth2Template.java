...
import com.ziyao.harbor.oauth2.error.OAuth2ResponseErrorHandler;
import com.ziyao.harbor.oauth2.http.SslHttpRequestFactory;
import com.ziyao.harbor.oauth2.http.converter.HttpMessageConverters;
 ...
 * @since 2024/1/10
 */
public class OAuth2Template extends RestTemplate {

    public OAuth2Template() {
        this.setInterceptors(new ArrayList<>());
        // 错误信息处理
        this.setErrorHandler(new OAuth2ResponseErrorHandler());
