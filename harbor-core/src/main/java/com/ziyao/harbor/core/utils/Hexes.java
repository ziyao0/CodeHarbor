...
import com.ziyao.harbor.core.codec.Base16Codec;
...
public abstract class Hexes {
    ...
    public static String encodeHexStr(String data) {
        return encodeHexStr(data, Charsets.CHARSET_UTF_8);
    }
    ...
    public static String decodeHexStr(String hexStr) {
        return decodeHexStr(hexStr, Charsets.CHARSET_UTF_8);
    }
    ...
    public static String format(String hexStr) {
        ...
        for (int i = 2; i < length - 1; i += 2) {
            builder.append(Chars.SPACE).append(hexStr.charAt(i)).append(hexStr.charAt(i + 1));
        }
        return builder.toString();
    }
}