...
public class AuthorizationServiceImpl extends ServiceImpl<AuthorizationMapper, Authorization> implements AuthorizationService {
    ...
    @Override
    public Page<Authorization> page(Page<Authorization> page, Oauth2AuthorizationDTO oauth2AuthorizationDTO) {
        LambdaQueryWrapper<Authorization> wrapper = oauth2AuthorizationDTO.initWrapper();
